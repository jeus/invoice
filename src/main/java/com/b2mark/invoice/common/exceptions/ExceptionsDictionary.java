...
public enum ExceptionsDictionary {
    ...
    ARGUMENTTOOLONG(1007, "ARGUMENT IS TOO LONG", HttpStatus.BAD_REQUEST),
    ...
    LIMITATION(2002, "LIMIT TO CREATE", HttpStatus.UNAUTHORIZED),
    BLOCKCHAINCONECTIVITY(3000,"BLOCKCHAIN CONNECTION ERROR",HttpStatus.INTERNAL_SERVER_ERROR);
